...
//   return (
//     <div>
//       {/* 1) HERO SECTION (fix white line + video touches navbar) */}
//       <SectionReveal
...
//       {/* 2) WHY ALGOARN (same section start spacing) */}
...
//                     {["✓ Nurture growth", "✓ Reduce skill gaps", "✓ Elevate results"].map(
//                       (benefit) => (
//                         <div
//                           key={benefit}
//                           className="flex items-center gap-2 text-indigo-700 font-semibold text-sm"
//                         >
//                           <span>{benefit}</span>
//                         </div>
//                       )
...
//                 {/*  Explore + Request Demo side-by-side */}
//                 <div className="pt-4">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4">
                  <div className="flex flex-col sm:flex-row gap-4 items-center">
                    ...
                    {/* ✅ OPEN MODAL (instead of /contact?type=suca) */}
                    {/* <Button
                      type="button"
