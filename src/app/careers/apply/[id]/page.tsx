...
export default function ApplyPage() {
  ...
  const [jobTitle, setJobTitle] = useState("Open role at Algoarn");
  ...
  useEffect(() => {
    async function fetchTitle() {
      ...
      if (error) {
        ...
        setJobTitle("Open role at Algoarn");
      } else {
        setJobTitle(data?.title ?? "Open role at Algoarn");
      }
      ...
      <div className="max-w-4xl mx-auto px-4 space-y-10">
        <div className="space-y-3">
          ...
          <h1 className="text-2xl md:text-3xl font-display font-bold">
            ...
            <span className="text-algoarnAqua">
              {loadingTitle ? "Loading…" : jobTitle}
            </span>
          </h1>

          <p
            className="text-xl leading-7 max-w-3xl mx-auto text-black"
        ...
        <NeonCard className="p-6 md:p-8 space-y-5">
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-1.5">
                <label className="text-s font-medium text-white">Phone</label>
                <Input
                  name="phone"
                  value={form.phone}
                  onChange={handleChange}
              ...
              <div className="space-y-1.5">
                <label className="text-s font-medium text-white">LinkedIn</label>
                <Input
                  name="linkedin"
                  value={form.linkedin}
                  onChange={handleChange}
